...
**DClaw Contract** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8059` (FastAPI)
- **Frontend Port:** `3059` (Next.js)
- **Database:** `dclaw_contract` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3059`
